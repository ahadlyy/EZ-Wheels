    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "RES001", null, null, 52.229700000000001, 21.0122, new DateTime(2024, 5, 12, 16, 14, 10, 922, DateTimeKind.Utc).AddTicks(7511), 52.520000000000003, 13.404999999999999, new DateTime(2024, 5, 8, 16, 14, 10, 922, DateTimeKind.Utc).AddTicks(7503) },
                    { "RES002", null, null, 34.052199999999999, -118.2437, new DateTime(2024, 5, 13, 16, 14, 10, 922, DateTimeKind.Utc).AddTicks(7518), 37.774900000000002, -122.4194, new DateTime(2024, 5, 9, 16, 14, 10, 922, DateTimeKind.Utc).AddTicks(7517) },
                    { "RES003", null, null, 33.749000000000002, -84.388000000000005, new DateTime(2024, 5, 14, 16, 14, 10, 922, DateTimeKind.Utc).AddTicks(7520), 40.712800000000001, -74.006, new DateTime(2024, 5, 10, 16, 14, 10, 922, DateTimeKind.Utc).AddTicks(7519) },
                    { "RES004", null, null, 48.8566, 2.3521999999999998, new DateTime(2024, 5, 15, 16, 14, 10, 922, DateTimeKind.Utc).AddTicks(7522), 51.507399999999997, -0.1278, new DateTime(2024, 5, 11, 16, 14, 10, 922, DateTimeKind.Utc).AddTicks(7522) },
                    { "RES005", null, null, 40.712800000000001, -74.006, new DateTime(2024, 5, 16, 16, 14, 10, 922, DateTimeKind.Utc).AddTicks(7524), 48.8566, 2.3521999999999998, new DateTime(2024, 5, 12, 16, 14, 10, 922, DateTimeKind.Utc).AddTicks(7524) }
                });
