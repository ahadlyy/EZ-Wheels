...
namespace Car_Rental_APIs.Migrations
{
    ...
    [Migration("20240503133128_Adding dummy data using EF core seeding method")]
    partial class AddingdummydatausingEFcoreseedingmethod
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Car_Rental_APIs.Models.CustomerRentCar", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndingDate = new DateTime(2024, 5, 8, 13, 31, 27, 582, DateTimeKind.Utc).AddTicks(5582),
                            PickUpLatitude = 52.520000000000003,
                            PickUpLongitude = 13.404999999999999,
                            StartingDate = new DateTime(2024, 5, 4, 13, 31, 27, 582, DateTimeKind.Utc).AddTicks(5572)
                        },
                        new
                        {
                            ...
                            EndingDate = new DateTime(2024, 5, 9, 13, 31, 27, 582, DateTimeKind.Utc).AddTicks(5586),
                            PickUpLatitude = 37.774900000000002,
                            PickUpLongitude = -122.4194,
                            StartingDate = new DateTime(2024, 5, 5, 13, 31, 27, 582, DateTimeKind.Utc).AddTicks(5585)
                        },
                        new
                        {
                            ...
                            EndingDate = new DateTime(2024, 5, 10, 13, 31, 27, 582, DateTimeKind.Utc).AddTicks(5588),
                            PickUpLatitude = 40.712800000000001,
                            PickUpLongitude = -74.006,
                            StartingDate = new DateTime(2024, 5, 6, 13, 31, 27, 582, DateTimeKind.Utc).AddTicks(5587)
                        },
                        new
                        {
                            ...
                            EndingDate = new DateTime(2024, 5, 11, 13, 31, 27, 582, DateTimeKind.Utc).AddTicks(5590),
                            PickUpLatitude = 51.507399999999997,
                            PickUpLongitude = -0.1278,
                            StartingDate = new DateTime(2024, 5, 7, 13, 31, 27, 582, DateTimeKind.Utc).AddTicks(5589)
                        },
                        new
                        {
                            ...
                            EndingDate = new DateTime(2024, 5, 12, 13, 31, 27, 582, DateTimeKind.Utc).AddTicks(5592),
                            PickUpLatitude = 48.8566,
                            PickUpLongitude = 2.3521999999999998,
                            StartingDate = new DateTime(2024, 5, 8, 13, 31, 27, 582, DateTimeKind.Utc).AddTicks(5591)
                        });
                });
